...
function Gift() {
  const steps = [
    { char: 'SB10', tint: 'var(--sb-wash-lemon)', title: 'Pick the edition', body: 'The Standard journal makes a lovely gift; the Gold Edition adds a gold-foil cover and wooden milestone coins - made for giving.' },
