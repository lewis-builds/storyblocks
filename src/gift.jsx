...
function Gift() {
  const steps = [
    { char: 'SB10', tint: 'var(--sb-wash-lemon)', title: 'Pick the edition', body: 'The Standard journal makes a lovely gift; the Gold Edition comes gift-boxed with a foil cover and bonus stickers - made for giving.' },
    ...
    { char: 'SB44', tint: 'var(--sb-wash-pink)', title: 'Watch them start', body: 'Three words and a friendly question, and they’re off. The Parent Companion helps the grown-ups cheer them on.' },
  ];
  return (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr)', gap: 40, alignItems: 'center' }} className="gift-grid">
        <div>
          ...
          <ul>
            ...
            <li><strong>The Gold Edition</strong> arrives in a keepsake gift box with a gold-foil cover and a bonus collector sticker set.</li>
            <li><strong>Grown-ups included.</strong> The free Parent Companion email helps the gift-giver stay part of the story.</li>
          </ul>
